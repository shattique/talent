                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-flat">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" method="post" action="{{url('admin/fields')}}">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" name="default_val" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <textarea name="optionlist" rows="5" cols="5" class="form-control"></textarea>
                                    </div>
                                </div>
