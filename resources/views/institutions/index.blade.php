        ...
        <div class="content">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">Institution List</h5>
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>{{ $row->ins_type }}</td>
                            <td>{{ $row->location }}</td>
                            <td><a href="{{action('InstitutionsController@edit', $row->id )}}" class="btn btn-warning">Edit</a></td>
                            <td>
                                <form action="{{action('InstitutionsController@destroy', $row->id)}}" onsubmit="return confirm ('Do you really want to delete?')" method="post">
                                    {{csrf_field()}}
